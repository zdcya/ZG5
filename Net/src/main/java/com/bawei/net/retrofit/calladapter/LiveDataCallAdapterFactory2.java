...
public class LiveDataCallAdapterFactory2 extends CallAdapter.Factory {


    public static LiveDataCallAdapterFactory2 create(){

        return new LiveDataCallAdapterFactory2();
    }
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        if (rawType == Call.class){
            ...
            return new LiveDataCallAdapter2<>(t);
        }
